...
public class AiParser extends Parser {
	...
	public static class FieldContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AiListener ) ((AiListener)listener).enterField(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AiListener ) ((AiListener)listener).exitField(this);
		}
	}
	...
	public static class RowContext extends ParserRuleContext {
		...
		public TerminalNode LineBreak() { return getToken(AiParser.LineBreak, 0); }
		public TerminalNode EOF() { return getToken(AiParser.EOF, 0); }
		public List<TerminalNode> Separator() { return getTokens(AiParser.Separator); }
		public TerminalNode Separator(int i) {
			return getToken(AiParser.Separator, i);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AiListener ) ((AiListener)listener).enterRow(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AiListener ) ((AiListener)listener).exitRow(this);
		}
	}
	...
	public static class ValueContext extends ParserRuleContext {
		public TerminalNode Value() { return getToken(AiParser.Value, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AiListener ) ((AiListener)listener).enterValue(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AiListener ) ((AiListener)listener).exitValue(this);
		}
	}
